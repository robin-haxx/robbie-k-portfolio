...
function refreshCanvas() {
  ...
  treated = [window.innerWidth,window.innerHeight];
...
function draw_one_frame(words, vocal, drum, bass, other, counter) {
  ...
  let whiteCol = color(75, 148, 103,50);
  let whiteColAlpha = color(0,0,0, 200);
  let whiteColHighAlpha = color(0,0,0, 50);
  let appleCol = color(240, 100, 80);
  let greenCol = color(80, 150, 90);
  let yellowCol = color(213, 219, 15);
  let blackCol = color(75, 148, 103);
  let creamCol = color(255, 255, 230);
  let greyCol = color(220, 220, 220);
  let greyColTwo = color(180, 180, 100);
